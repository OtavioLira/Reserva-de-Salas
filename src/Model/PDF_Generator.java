    ...
    public static void GerarPDF(){
       ...
       if(retorno == JFileChooser.APPROVE_OPTION){
        ...
        try{
            ...
            camp.setAlignment(Element.ALIGN_CENTER);
            documentopdf.add(camp);
            documentopdf.add(new Paragraph(" "));
            documentopdf.add(new Paragraph(" "));
            Paragraph assCli =  (new Paragraph("Assinatura do cliente:", texto));
            assCli.setAlignment(Element.ALIGN_CENTER);
            documentopdf.add(assCli);
            documentopdf.add(new Paragraph(" "));
            documentopdf.add(camp);
            documentopdf.add(new Paragraph(" "));
            documentopdf.add(new Paragraph(" "));
            documentopdf.add(new Paragraph(View.PDF_GUI.NameEmpresa_TXT.getText()+"®", texto));
            documentopdf.add(new Paragraph(" "));
            Paragraph preface2 = new Paragraph("Roomtron ®", titulo);
            preface2.setAlignment(Element.ALIGN_CENTER);
            documentopdf.add(preface2);
            documentopdf.add(new Paragraph(" "));
